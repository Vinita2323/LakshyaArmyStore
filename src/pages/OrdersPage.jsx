...
export default function OrdersPage() {
  ...
  let rawOrders = appOrders && appOrders.length > 0 ? appOrders.map((o) => ({
    id: o.id,
    date: `Ordered on ${o.date}`,
    status: o.status || 'Processing',
    name: o.items && o.items.length > 0 
            ? (o.items.length === 1 ? o.items[0].name : `${o.items[0].name} + ${o.items.length - 1} more items`) 
            : 'Product',
    image: (o.items && o.items[0] && o.items[0].image) ? o.items[0].image : fallbackImages[0],
    rating: o.rating || 0,
    ratingText: o.ratingText || (o.status === 'Delivered' ? 'Rate & Review' : '')
  })) : MOCK_ORDERS;
