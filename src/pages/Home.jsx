...
import prodUniform1 from '../assets/CategorySection/uniform.jpg';
import prodWatch1 from '../assets/CategorySection/watch1.jpg';
import prodFootwear1 from '../assets/CategorySection/footwear.jpg';
import prodUniform2 from '../assets/CategorySection/uniform2.jpg';
  ...
  const getHomeFilteredDeals = () => {
    ...
    switch (selectedCategory) {
      case 'for-you':
        return items;
      case 'uniform':
        return items.filter((p) => ['tee', 'pants', 'blouse', 'outfit'].includes(p.type));
      case 'footwear':
        return items.filter((p) => ['shoes', 'sneakers', 'boots'].includes(p.type));
      case 'watches-electronics':
        return items.filter((p) => ['watch', 'earbuds', 'powerbank', 'fan', 'headphones', 'smartwatch'].includes(p.type));
      case 'toys':
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              <div>
                <div className="bg-[#F8F9FD] rounded-md w-full aspect-square flex items-center justify-center mb-2 relative overflow-hidden group">
                  <img src={prodUniform1} alt="Army Combat Uniform" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                </div>
            ...
            >
              <div>
                <div className="bg-[#F8F9FD] rounded-md w-full aspect-square flex items-center justify-center mb-2 relative overflow-hidden group">
                  <img src={prodWatch1} alt="Tactical Smart Watch" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                </div>
                <span className="text-[9.5px] font-medium text-slate-400 tracking-tight leading-normal px-1">
            ...
            >
              <div>
                <div className="bg-[#F8F9FD] rounded-md w-full aspect-square flex items-center justify-center mb-2 relative overflow-hidden group">
                  <img src={prodFootwear1} alt="Tactical Combat Boots" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                </div>
                <span className="text-[9.5px] font-medium text-slate-400 tracking-tight leading-normal px-1">
            ...
            >
              <div>
                <div className="bg-[#F8F9FD] rounded-md w-full aspect-square flex items-center justify-center mb-2 relative overflow-hidden group">
                  <img src={prodUniform2} alt="Tactical Camouflage" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                </div>
                <span className="text-[9.5px] font-medium text-slate-400 tracking-tight leading-normal px-1">
                  Tactical Camouflage
                </span>
      ...
      <div className="px-4 py-2 space-y-3">
        ...
        <div className="px-3 py-2 animate-fade-in pb-10 mt-1">
          ...
          <div className="mt-8 px-1">
            <h3 className="text-[17px] font-black text-slate-900 tracking-tight mb-4">Top Uniforms & Clothing</h3>
            <div className="grid grid-cols-2 gap-3">
              {filteredDeals.map((deal) => (
                <ProductCard key={`uniform-top-${deal.id}`} product={deal} />
              ))}
            </div>
          </div>
        </div>
      ) : selectedCategory === 'watches-electronics' ? (
        <div className="px-3 py-2 animate-fade-in pb-10 mt-1">
          <div className="grid grid-cols-5 gap-x-3 gap-y-5 pt-2 pb-2 w-full">
            {filteredDeals.map((deal) => (
              <div 
